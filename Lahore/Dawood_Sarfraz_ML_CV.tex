...
\begin{document}
	...
	\resumeItemListStart
	\resumeItem{\normalsize{I worked on live video streaming by converting RTSP streams to WebRTC and performed traffic analysis using computer vision techniques. This involved real-time video processing for efficient streaming and analytics.}}
	\resumeItemListEnd
	...
	\resumeProjectHeading
	{\textbf{\large{{Text Generation }}}\href{https://github.com/Dawoodsarfraz/text-generation}{\normalsize{\color{blue} Project Link}}}
	\resumeItemListStart
